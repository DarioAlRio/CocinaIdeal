...
function headerHtml(path) {
  ...
  <header class="site-header">
    <div class="wrap header-inner">
      <a class="logo" href="/">
        <span class="logo-mark" aria-hidden="true">${icon("pot")}</span>
      ...
      <div class="foot-grid">
        <div class="foot-brand">
          ...
          <p class="foot-contact">
            ${icon("mail")}
            <a href="#" class="js-mail" data-correo="hola|cocinaideal.es">activar JavaScript para ver el correo</a>
          </p>
        </div>
        ${columnas}
      </div>
...
function pageHero({ eyebrow, title, dek, updated, img, imgAlt }) {
  return `<section class="page-hero${img ? " page-hero-with-img" : ""}">
    <div class="wrap${img ? " page-hero-inner" : ""}">
      ...
      ${img ? `<img class="page-hero-img" src="${img}" alt="${imgAlt || ""}" loading="lazy" width="480" height="320">` : ""}
    </div>
  </section>`;
}
...
function ctaBand() {
  return `<section class="cta-band">
    <div class="wrap">
      ...
      <p>Empieza por la guía que más te interese ahora mismo: robots de cocina, freidoras de aire o cafeteras.</p>
